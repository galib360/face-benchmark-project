...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, z, sample=True, temperature=2, k=1):
        ...
        if not sample:
            ...
            min_encoding_indices = torch.multinomial(probabilities, num_samples=k)
            if k > 1:
                min_encoding_indices = min_encoding_indices[:, [-1]]
