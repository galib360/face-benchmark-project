...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="multiface", help='Name of the dataset folder. eg: BIWI')
    parser.add_argument("--vertice_dim", type=int, default=18516, help='number of vertices - 23370*3 for BIWI dataset')
    ...
    parser.add_argument("--save_path", type=str, default="save_multiface_2", help='path of the trained models')
    parser.add_argument("--result_path", type=str, default="result_multiface_2", help='path to the predictions')
    parser.add_argument("--train_subjects", type=str, default="2 3 6 7 9 10 11 12 13")
    parser.add_argument("--val_subjects", type=str, default="2 3 6 7 9 10 11 12 13")
    parser.add_argument("--test_subjects", type=str, default="2 3 6 7 9 10 11 12 13 1 4 5 8")
